...
PRODUCT_COPY_FILES += \
    ...
    $(VENDOR_PATH)/etc/camera/hwaae/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaae/device.config \
    $(VENDOR_PATH)/etc/camera/hwaae/ov8858/HwaAePara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaae/ov8858/HwaAePara.xml \
    $(VENDOR_PATH)/etc/camera/hwaae/ov2680/HwaAePara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaae/ov2680/HwaAePara.xml \
    $(VENDOR_PATH)/etc/camera/hwaae/mt9d015/HwaAePara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaae/mt9d015/HwaAePara.xml \
    $(VENDOR_PATH)/etc/camera/hwaae/imx219/HwaAePara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaae/imx219/HwaAePara.xml \
    $(VENDOR_PATH)/etc/camera/pdafvalidation.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/pdafvalidation.xml \
    $(VENDOR_PATH)/etc/camera/tracking/targettracking.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tracking/targettracking.xml \
    $(VENDOR_PATH)/etc/camera/multidenoise/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/multidenoise/device.config \
    $(VENDOR_PATH)/etc/camera/multidenoise/default/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/multidenoise/default/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/multidenoise/multidenoise.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/multidenoise/multidenoise.xml \
    $(VENDOR_PATH)/etc/camera/hwscope/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwscope/device.config \
    $(VENDOR_PATH)/etc/camera/hwscope/default/hwsz.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwscope/default/hwsz.xml \
    $(VENDOR_PATH)/etc/camera/hwscope/default/kernel:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwscope/default/kernel \
    $(VENDOR_PATH)/etc/camera/filter/filter.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/filter/filter.xml \
    $(VENDOR_PATH)/etc/camera/filter/mixIm.dat:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/filter/mixIm.dat \
    $(VENDOR_PATH)/etc/camera/ppconfig.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/ppconfig.xml \
    $(VENDOR_PATH)/etc/camera/tornado/NightModelTOA.model:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/NightModelTOA.model \
    $(VENDOR_PATH)/etc/camera/tornado/imx278_lg/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx278_lg/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/ov8865/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/ov8865/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/ov5648/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/ov5648/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/device.config \
    $(VENDOR_PATH)/etc/camera/tornado/ov13850/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/ov13850/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/ov8858/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/ov8858/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx230_sunny/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx230_sunny/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/default/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/default/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/ov2680/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/ov2680/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx179_front/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx179_front/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/NightMinMaxTOA.txt:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/NightMinMaxTOA.txt \
    $(VENDOR_PATH)/etc/camera/tornado/imx278_sunny/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx278_sunny/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx230_lg/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx230_lg/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx230_liteon/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx230_liteon/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/SunsetMinMaxTOA.txt:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/SunsetMinMaxTOA.txt \
    $(VENDOR_PATH)/etc/camera/tornado/FoliageModelTOA.model:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/FoliageModelTOA.model \
    $(VENDOR_PATH)/etc/camera/tornado/FoliageMinMaxTOA.txt:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/FoliageMinMaxTOA.txt \
    $(VENDOR_PATH)/etc/camera/tornado/SunsetModelTOA.model:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/SunsetModelTOA.model \
    $(VENDOR_PATH)/etc/camera/tornado/mt9d015/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/mt9d015/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx179_front_plk_liteon/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx179_front_plk_liteon/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx179_front_plk_sunny/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx179_front_plk_sunny/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx219/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx219/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/tornado/imx278_liteon/TornadoI.ini:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/tornado/imx278_liteon/TornadoI.ini \
    $(VENDOR_PATH)/etc/camera/hwldc/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwldc/device.config \
    $(VENDOR_PATH)/etc/camera/hwldc/imx179_front/hwldc_config.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwldc/imx179_front/hwldc_config.xml \
    $(VENDOR_PATH)/etc/camera/hwldc/imx179_front_liteon/hwldc_config.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwldc/imx179_front_liteon/hwldc_config.xml \
    $(VENDOR_PATH)/etc/camera/hwldc/imx179_front_sunny/hwldc_config.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwldc/imx179_front_sunny/hwldc_config.xml \
    $(VENDOR_PATH)/etc/camera/hwldc/imx179_front_plk_liteon/hwldc_config.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwldc/imx179_front_plk_liteon/hwldc_config.xml \
    $(VENDOR_PATH)/etc/camera/hwldc/imx179_front_plk_sunny/hwldc_config.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwldc/imx179_front_plk_sunny/hwldc_config.xml \
    $(VENDOR_PATH)/etc/camera/ippalgoconfig.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/ippalgoconfig.xml \
    $(VENDOR_PATH)/etc/camera/smartae/imx278_lg/SmartAE.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/imx278_lg/SmartAE.xml \
    $(VENDOR_PATH)/etc/camera/smartae/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/device.config \
    $(VENDOR_PATH)/etc/camera/smartae/ov13850/SmartAE.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/ov13850/SmartAE.xml \
    $(VENDOR_PATH)/etc/camera/smartae/imx230_sunny/SmartAE.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/imx230_sunny/SmartAE.xml \
    $(VENDOR_PATH)/etc/camera/smartae/imx278_sunny/SmartAE.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/imx278_sunny/SmartAE.xml \
    $(VENDOR_PATH)/etc/camera/smartae/imx230_lg/SmartAE.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/imx230_lg/SmartAE.xml \
    $(VENDOR_PATH)/etc/camera/smartae/imx230_liteon/SmartAE.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/imx230_liteon/SmartAE.xml \
    $(VENDOR_PATH)/etc/camera/smartae/imx278_liteon/SmartAE.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/smartae/imx278_liteon/SmartAE.xml \
    $(VENDOR_PATH)/etc/camera/nicefood/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/nicefood/device.config \
    $(VENDOR_PATH)/etc/camera/nicefood/default/niceFood.dat:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/nicefood/default/niceFood.dat \
    $(VENDOR_PATH)/etc/camera/davinci/ov8865/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8865/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov8865/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8865/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov8865/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8865/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx230/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx230/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx230/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx230/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx230/NICEFOOD/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx230/NICEFOOD/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx230/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx230/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/device.config \
    $(VENDOR_PATH)/etc/camera/davinci/ar1335/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ar1335/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ar1335/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ar1335/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ar1335/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ar1335/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov13850/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov13850/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov13850/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov13850/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov13850/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov13850/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov8858/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8858/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov8858/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8858/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov8858/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8858/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/default/cm_normal.dat:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/cm_normal.dat \
    $(VENDOR_PATH)/etc/camera/davinci/default/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/default/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/default/cm_foliage.dat:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/cm_foliage.dat \
    $(VENDOR_PATH)/etc/camera/davinci/default/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/default/cm_sunset.dat:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/cm_sunset.dat \
    $(VENDOR_PATH)/etc/camera/davinci/default/cm_sky.dat:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/cm_sky.dat \
    $(VENDOR_PATH)/etc/camera/davinci/default/cm_correction.dat:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/default/cm_correction.dat \
    $(VENDOR_PATH)/etc/camera/davinci/ov8865_front/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8865_front/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov8865_front/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8865_front/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov8865_front/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov8865_front/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov2680/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov2680/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov2680/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov2680/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov2680/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov2680/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx179_front/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx179_front/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx179_front/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx179_front/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx179_front/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx179_front/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx328/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx328/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx328/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx328/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx328/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx328/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx179_front_plk/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx179_front_plk/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx179_front_plk/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx179_front_plk/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx179_front_plk/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx179_front_plk/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/mt9d015/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/mt9d015/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/mt9d015/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/mt9d015/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/mt9d015/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/mt9d015/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov5648_x1s/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov5648_x1s/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov5648_x1s/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov5648_x1s/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/ov5648_x1s/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/ov5648_x1s/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/s5k4e1ga/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/s5k4e1ga/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/s5k4e1ga/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/s5k4e1ga/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/s5k4e1ga/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/s5k4e1ga/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx219/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx219/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx219/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx219/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx219/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx219/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx278/multiframe.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx278/multiframe.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx278/hdr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx278/hdr.xml \
    $(VENDOR_PATH)/etc/camera/davinci/imx278/imgproc.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/imx278/imgproc.xml \
    $(VENDOR_PATH)/etc/camera/davinci/davinciclkernel.bin:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/davinci/davinciclkernel.bin \
    $(VENDOR_PATH)/etc/camera/afParams.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/afParams.xml \
    $(VENDOR_PATH)/etc/camera/dcsr/dcsr.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/dcsr/dcsr.xml \
    $(VENDOR_PATH)/etc/camera/dcsr/dcsr_kernel:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/dcsr/dcsr_kernel \
    $(VENDOR_PATH)/etc/camera/hwaflash/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaflash/device.config \
    $(VENDOR_PATH)/etc/camera/hwaflash/ov8858/HwaFlashPara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaflash/ov8858/HwaFlashPara.xml \
    $(VENDOR_PATH)/etc/camera/hwaflash/ov2680/HwaFlashPara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaflash/ov2680/HwaFlashPara.xml \
    $(VENDOR_PATH)/etc/camera/hwaflash/mt9d015/HwaFlashPara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaflash/mt9d015/HwaFlashPara.xml \
    $(VENDOR_PATH)/etc/camera/hwaflash/imx219/HwaFlashPara.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/hwaflash/imx219/HwaFlashPara.xml \
    $(VENDOR_PATH)/etc/camera/dcvalidation.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/dcvalidation.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/ov8865/info.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/ov8865/info.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/ov8865/algo.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/ov8865/algo.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/imx230/info.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/imx230/info.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/imx230/algo.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/imx230/algo.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/device.config:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/device.config \
    $(VENDOR_PATH)/etc/camera/bshutter/imx179/info.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/imx179/info.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/imx179/algo.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/imx179/algo.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/default/info.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/default/info.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/default/algo.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/default/algo.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/imx278/info.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/imx278/info.xml \
    $(VENDOR_PATH)/etc/camera/bshutter/imx278/algo.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/camera/bshutter/imx278/algo.xml \
